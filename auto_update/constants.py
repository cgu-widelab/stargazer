SUNSET_DATA_URL = 'https://opendata.cwb.gov.tw/govdownload?dataid=A-B0062-001&authorizationkey=rdec-key-123-45678-011121314'
WEATHER_3DAY_DATA_URL = 'https://opendata.cwb.gov.tw/govdownload?dataid=F-D0047-093&authorizationkey=rdec-key-123-45678-011121314'
WEATHER_7DAY_DATA_URL = 'https://opendata.cwb.gov.tw/govdownload?dataid=F-D0047-093&authorizationkey=rdec-key-123-45678-011121314'
XML_NAMESPACE = {"all": "urn:cwb:gov:tw:cwbcommon:0.1"}
SUNSET_DATA_NEEDED = ['日出時刻', '日沒時刻']
ZIP_CODE = {
    '臺北市': {
    ...
    '臺南市': {
        ...
        '善化區': 741,
        '大內區': 742, '山上區': 743, '新市區': 744, '安定區': 745
    },
    '高雄市': {
        '新興區': 800, '前金區': 801, '苓雅區': 802, '鹽埕區': 803,
        '鼓山區': 804, '旗津區': 805, '前鎮區': 806, '三民區': 807,
        '楠梓區': 811, '小港區': 812, '左營區': 813, '仁武區': 814,
        '大社區': 815, '東沙群島': 817, '南沙群島': 819, '岡山區': 820,
        '路竹區': 821, '阿蓮區': 822, '田寮區': 823, '燕巢區': 824,
        '橋頭區': 825, '梓官區': 826, '彌陀區': 827, '永安區': 828,
        '湖內區': 829, '鳳山區': 830, '大寮區': 831, '林園區': 832,
        '鳥松區': 833, '大樹區': 840, '旗山區': 842, '美濃區': 843,
        '六龜區': 844, '內門區': 845, '杉林區': 846, '甲仙區': 847,
        '桃源區': 848, '那瑪夏區': 849, '茂林區': 851, '茄萣區': 852
    },
    '澎湖縣': {
    ...
    '新竹市': {'東區': 30001, '北區': 30002, '香山區': 30003},
    '嘉義市': {'東區': 60001, '西區': 60002},
